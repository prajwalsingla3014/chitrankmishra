...
void question1()
{
    char ch;
    FILE *ques1;
ques1= fopen("C:\\Users\\Chitrank\\Desktop\\CS project\\question1.txt","r");
       int flag=0;
    for(int k=0;k<10;k++)
    {
        userinq1[k]=NULL;
...
void superheroes(){
   char ch;
FILE *ques;
ques=fopen("C:\\Users\\Chitrank\\Desktop\\CS project\\Superheroes.txt","r");
FILE *answ;
answ=fopen("C:\\Users\\Chitrank\\Desktop\\CS project\\superheroans.txt","r");
...
char ch;
FILE *ques;
ques=fopen("C:\\Users\\Chitrank\\Desktop\\CS project\\cricketersques.txt","r");
FILE *answ;
answ=fopen("C:\\Users\\Chitrank\\Desktop\\CS project\\cricketersans.txt","r");
...
char ch;
FILE *ques;
ques=fopen("C:\\Users\\chitr\\Desktop\\CS project\\cartoonques.txt","r");
FILE *answ;
answ=fopen("C:\\Users\\chitr\\Desktop\\CS project\\cartoonans.txt","r");
...
void bollywood(){
   char ch;
FILE *ques;
ques=fopen("C:\\Users\\chitr\\Desktop\\CS project\\actorques.txt","r");
FILE *answ;
answ=fopen("C:\\Users\\chitr\\Desktop\\CS project\\actorans.txt","r");
...
void UI(){
    ...
    system("color 0A");
    drawbox(1,0,117,29,10);
    system("color 0C");
    delay(300);
    system("color 0A");
    delay(300);
    logo(32,4);
    PlaySound(TEXT("C:\\Users\\Chitrank\\Desktop\\CS project\\welcome.wav"),NULL,SND_SYNC);
    system("color 0C");
    delay(300);
    drawbox(30,3,87,11,10);
    drawbox(28,2,89,12,10);
    system("color 0C");
    delay(300);
    system("color 0A");
    delay(300);
